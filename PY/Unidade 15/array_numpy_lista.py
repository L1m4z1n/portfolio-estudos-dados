...
import numpy as np
array = np.array([1,2,3,4,5])
novo_array = array * 10 # isso multiplicara por 10 a todos os elementos
print(novo_array)
...
# Crie uma lista e um array com 10 milhões números
...
# Calcule a soma de todos os números nos array
inicio = time.time()
