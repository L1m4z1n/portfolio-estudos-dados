...
produto_cadastrado = input('Nome do produto:\n').lower()

if produto_cadastrado in produtos:
    i_produto = produtos.index(produto_cadastrado)
    produto_nome = produtos[i_produto]
    print("Produto já existente, tente novamente")
else:
    produtos.append(produto_cadastrado)
    print(f'Produto : {produto_cadastrado} cadastrado com sucesso!!!')
